        ...
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
                ...
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                            ...
                            <li class="m-nav__item">
                                <a href="{{ url('securepanel/roles/add') }}" title="{{trans('label.roles_add_title')}}" class="m-nav__link">
                                    <span class="m-nav__link-text">
            ...
            <div class="m-content">
                <div class="m-portlet m-portlet--mobile">
                    ...
                    <!--BEGIN: Form -->
                    {!! Form::open(['name' => 'form_role', 'id' => 'form_role', 'method' => 'POST', 'class' => 'm-form m-form--fit m-form--label-align-right ', 'route' => ['securepanel.roles.store']]) !!}
                    @if (count($errors) > 0)
                        <br>
                    ...
                    <div class="m-portlet__foot m-portlet__no-border m-portlet__foot--fit">
                        <div class="m-form__actions m-form__actions--solid">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <button id="m_role_add_submit" class="btn btn-success">
...
@section('pagescript')
    <script src="{{ url('laraking/backend/js/pages/role_add.js') }}" type="text/javascript"></script>
@stop
